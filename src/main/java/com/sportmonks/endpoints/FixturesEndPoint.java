...
public class FixturesEndPoint extends AbstractEndPoint {
     ...
     *
     * @param customHourRateLimit : APIClient.FREE_PLAN_RATE_LIMIT,
     * APIClient.CLASSIC_PLAN_RATE_LIMIT
     *
     * @return
     */
    ...
    public List<Fixture> findSeverals(final String url, final FixturesEndPointParams params) {
        ...
        final HttpResponse<Fixtures> httpResponse = RestTool.get(url, paramsMap,
                params.getAdditionalParams(), Fixtures.class);
        try {
    ...
    public enum Relation {
        odds, localTeam, visitorTeam, substitutions, goals, cards, other, lineup, bench, stats, comments, tvstations, highlights, league, season, round, stage, referee, events, venue
    }
